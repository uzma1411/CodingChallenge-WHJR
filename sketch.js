...
function setup() {
  ...
  ropebtn1 = createImg('cut_btn.png');
  ropebtn1.position(90,70);
  ropebtn1.size(80,80);
  ropebtn1.mouseClicked(drop);

  //Add rope btn 2
  ropebtn2 = createImg('cut_btn.png');
  ropebtn2.position(450,70);
  ropebtn2.size(80,80);
   ropebtn2.mouseClicked(drop2);
...
//text("X : "+mouseX+" Y: "+mouseY,mouseX,mouseY)  // - for checking the position and placing the 2 btns. 

  //Add fruit and Bunny collide function here
  ...
  //Add star collide function here
  if(collide(fruit,star,20)==true){
    star.visible=false;
  
  }

  //Add star2 collide function here
